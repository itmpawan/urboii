 ...
 * @since 1.0.0
 */
class Organey_Elementor_Brand extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Brands', 'organey');
    }
    ...
    public function get_script_depends() {
        return ['organey-elementor-brand', 'slick'];
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            'brand_title',
            [
                'label'       => esc_html__('Brand name', 'organey'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Brand Name', 'organey'),
                'placeholder' => esc_html__('Brand Name', 'organey'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'options' => [
                    'image' => esc_html__('Image', 'organey'),
                    'icon'  => esc_html__('Icon & SVG', 'organey'),
                ],
                'default' => 'image',
            ]
        );
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Border::get_type(),
            [
                'name'     => 'brand_wrapper_border_hover',
        ...
        $this->start_controls_section(
            'style_brand_icon',
            [
                'label' => esc_html__('Icon & SVG', 'organey'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
                        ...
                        <div <?php echo organey_elementor_get_render_attribute_string('item', $this); // WPCS: XSS ok. ?>>
                            <div class="elementor-brand-image">
                                ...
                                if (!empty($item['link'])) {
                                    ...
                                    echo '<a href="' . esc_url($item['link']['url'] ? $item['link']['url'] : '#') . '" ' . organey_elementor_get_render_attribute_string('brand-image', $this) . ' title="' . esc_attr($item['brand_title']) . '">';
                                }
                                ...
                                if ($item['type_brand'] == 'image') {
                                    ...
                                    if ($is_new || $migrated) {
                                        ...
                                        <i <?php echo organey_elementor_get_render_attribute_string('icon', $this); // WPCS: XSS ok. ?>></i>
                                        <?php
                                    }
                                }
                                if (!empty($item['link'])) {
...
$widgets_manager->register(new Organey_Elementor_Brand());
