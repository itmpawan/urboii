 ...
 * @since 1.0.0
 */
class Organey_Elementor_Language_Switcher extends Elementor\Widget_Base {
	...
	public function get_name() {
		return 'organey-language-switcher';
	}
	...
	public function get_title() {
		return esc_html__( 'Language Switcher', 'organey' );
	}
	...
	protected function register_controls() {
		...
		$this->add_group_control(
			...
			[
				'name'     => 'typography',
				'selector' => '{{WRAPPER}} .organey-language-switcher span',
			]
		);
		...
		$this->add_control(
			'hover_right',
			[
				'label'        => esc_html__( 'Hover Right', 'organey' ),
	...
	protected function render() {
		organey_language_switcher();
	}
}

$widgets_manager->register( new Organey_Elementor_Language_Switcher() );
