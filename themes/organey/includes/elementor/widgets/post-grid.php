...
/**
 * Class Organey_Elementor_Blog
 */
class Organey_Elementor_Post_Grid extends Elementor\Widget_Base {


    public function get_name() {
        return 'organey-post-grid';
    }

    public function get_title() {
        return esc_html__('Posts Grid', 'organey');
    }
    ...
    public function get_script_depends() {
        return ['organey-elementor-post-grid', 'slick'];
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_query',
            [
                'label' => esc_html__('Query', 'organey'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'post_date',
                'options' => [
                    'post_date'  => esc_html__('Date', 'organey'),
                    'post_title' => esc_html__('Title', 'organey'),
        ...
        $this->start_controls_section(
            'section_pagination',
            [
                'label' => esc_html__('Pagination', 'organey'),
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'numbers'               => esc_html__('Numbers', 'organey'),
                    'prev_next'             => esc_html__('Previous/Next', 'organey'),
                    'numbers_and_prev_next' => esc_html__('Numbers', 'organey') . ' + ' . esc_html__('Previous/Next', 'organey'),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Page Limit', 'organey'),
                'default'   => '5',
                'condition' => [
                    'pagination_type!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Shorten', 'organey'),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Previous Label', 'organey'),
                'default'   => esc_html__('&laquo; Previous', 'organey'),
                'condition' => [
                    'pagination_type' => [
                        'prev_next',
                        'numbers_and_prev_next',
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Next Label', 'organey'),
                'default'   => esc_html__('Next &raquo;', 'organey'),
                'condition' => [
                    'pagination_type' => [
                        'prev_next',
                        'numbers_and_prev_next',
    ...
    protected function render_loop_footer() {
        ...
        if ($has_numbers) {
            $links = paginate_links([
                ...
                'before_page_number' => '<span class="elementor-screen-only">' . esc_html__('Page', 'organey') . '</span>',
            ]);
        }
        ...
        <div class="pagination">
            <nav class="elementor-pagination" role="navigation"
                 aria-label="<?php esc_attr_e( 'Pagination', 'organey' ); ?>">
    ...
    protected function add_control_carousel($condition = array()) {
        ...
        $this->add_control(
            'dot_vertical',
            [
                'label'       => esc_html__('Vertical', 'organey'),
                'type'        => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options'     => [
                    'top'    => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .slick-dots' => 'top: unset; bottom: unset; {{dot_vertical.value}}: {{SIZE}}{{UNIT}};',
                ]
            ]
        );
        $this->add_control(
            'dot_horizontal',
            [
                'label'       => esc_html__('Horizontal', 'organey'),
                'type'        => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options'     => [
                    'left'  => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .slick-dots' => 'left: unset; right: unset;{{dot_horizontal.value}}: {{SIZE}}{{UNIT}};',
                ]
            ]
        );
...
$widgets_manager->register( new Organey_Elementor_Post_Grid() );
