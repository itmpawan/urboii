...
class Organey_breadcrumb {
    ...
    public function breadcrumb_register() {
        $labels = [
            'name'               => esc_html__('Breadcrumbs', 'organey'),
            'singular_name'      => esc_html__('Breadcrumb', 'organey'),
            'menu_name'          => esc_html__('Breadcrumbs', 'organey'),
            'name_admin_bar'     => esc_html__('Breadcrumb', 'organey'),
            'add_new'            => esc_html__('Add New', 'organey'),
            'add_new_item'       => esc_html__('Add New Breadcrumb', 'organey'),
            'new_item'           => esc_html__('New Header Footer & Blocks Template', 'organey'),
            'edit_item'          => esc_html__('Edit Header Footer & Blocks Template', 'organey'),
            'view_item'          => esc_html__('View Header Footer & Blocks Template', 'organey'),
            'all_items'          => esc_html__('All Breadcrumb', 'organey'),
            'search_items'       => esc_html__('Search Header Footer & Blocks Templates', 'organey'),
            'parent_item_colon'  => esc_html__('Parent Header Footer & Blocks Templates:', 'organey'),
            'not_found'          => esc_html__('No Header Footer & Blocks Templates found.', 'organey'),
            'not_found_in_trash' => esc_html__('No Header Footer & Blocks Templates found in Trash.', 'organey'),
        ];
        ...
        register_post_type('organey-breadcrumb', $args);
    }
    ...
    public function register_admin_menu() {
        add_submenu_page(
            'themes.php',
            esc_html__('Breadcrumbs', 'organey'),
            esc_html__('Breadcrumbs', 'organey'),
            'edit_pages',
            'edit.php?post_type=organey-breadcrumb'
        );
    }
    ...
    function ehf_register_metabox() {
        add_meta_box(
            'ehf-meta-box',
            esc_html__('Breadcrumb Options', 'organey'),
            [
                $this,
                'efh_metabox_render',
            ],
        ...
        <table class="hfe-options-table widefat">
            ...
            <tr class="bsf-target-rules-row hfe-options-row">
                <td class="bsf-target-rules-row-heading hfe-options-row-heading">
                    <label><?php esc_html_e('Display On', 'organey'); ?></label>
                    <i class="bsf-target-rules-heading-help dashicons dashicons-editor-help"
                       title="<?php echo esc_attr__('Add locations for where this template should appear.', 'organey'); ?>"></i>
                </td>
                <td class="bsf-target-rules-row-content hfe-options-row-content">
                    ...
                    HFE\Lib\Astra_Target_Rules_Fields::target_rule_settings_field(
                        ...
                        [
                            'title'          => esc_html__('Display Rules', 'organey'),
                            'value'          => '[{"type":"basic-global","specific":null}]',
                            'tags'           => 'site,enable,target,pages',
                            'rule_type'      => 'display',
                            'add_rule_label' => esc_html__('Add Display Rule', 'organey'),
                        ],
                        $include_locations
                    );
                    ?>
            ...
            <tr class="bsf-target-rules-row hfe-options-row">
                <td class="bsf-target-rules-row-heading hfe-options-row-heading">
                    <label><?php esc_html_e('Do Not Display On', 'organey'); ?></label>
                    <i class="bsf-target-rules-heading-help dashicons dashicons-editor-help"
                       title="<?php echo esc_attr__('Add locations for where this template should not appear.', 'organey'); ?>"></i>
                </td>
                <td class="bsf-target-rules-row-content hfe-options-row-content">
                    <?php
                    HFE\Lib\Astra_Target_Rules_Fields::target_rule_settings_field(
                        ...
                        [
                            'title'          => esc_html__('Exclude On', 'organey'),
                            'value'          => '[]',
                            'tags'           => 'site,enable,target,pages',
                            'add_rule_label' => esc_html__('Add Exclusion Rule', 'organey'),
                            'rule_type'      => 'exclude',
                        ],
                        $exclude_locations
                    );
            ...
            <tr class="bsf-target-rules-row hfe-options-row">
                <td class="bsf-target-rules-row-heading hfe-options-row-heading">
                    <label><?php esc_html_e('User Roles', 'organey'); ?></label>
                    <i class="bsf-target-rules-heading-help dashicons dashicons-editor-help" title="<?php echo esc_attr__('Display custom template based on user role.', 'organey'); ?>"></i>
                </td>
                <td class="bsf-target-rules-row-content hfe-options-row-content">
                    <?php
                    HFE\Lib\Astra_Target_Rules_Fields::target_user_role_settings_field(
                        ...
                        [
                            'title'          => esc_html__('Users', 'organey'),
                            'value'          => '[]',
                            'tags'           => 'site,enable,target,pages',
                            'add_rule_label' => esc_html__('Add User Rule', 'organey'),
                        ],
                        $users
                    );
                    ?>
    ...
    public function get_template_id() {
        ...
        $hfe_templates = Astra_Target_Rules_Fields::get_instance()->get_posts_by_conditions('organey-breadcrumb', $option);
        $template_id   = 0;
    ...
    public function block_template_frontend() {
        if (is_singular('organey-breadcrumb') && !current_user_can('edit_posts')) {
    ...
    function load_canvas_template($single_template) {
        ...
        if ('organey-breadcrumb' == $post->post_type) {
