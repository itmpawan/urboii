...
class Organey_Widget_Layered_Nav extends WC_Widget {

    /**
     * Constructor.
     */
    public function __construct() {
        $this->widget_cssclass    = 'woocommerce organey_widget_layered_nav woocommerce-widget-layered-nav';
        $this->widget_description = esc_html__('Display a list of attributes to filter products in your store.(Organey custom)', 'organey');
        $this->widget_id          = 'organey_woocommerce_layered_nav';
        $this->widget_name        = esc_html__('Organey Filter Products by Attribute', 'organey');
        parent::__construct();
    }
    ...
    public function init_settings() {
        ...
        $this->settings = array(
            'title'      => array(
                'type'  => 'text',
                'std'   => esc_html__('Filter by', 'organey'),
                'label' => esc_html__('Title', 'organey'),
            ),
            'attribute'  => array(
                'type'    => 'select',
                'std'     => '',
                'label'   => esc_html__('Attribute', 'organey'),
                'options' => $attribute_array,
            ),
            'query_type' => array(
                'type'    => 'select',
                'std'     => 'and',
                'label'   => esc_html__('Query type', 'organey'),
                'options' => array(
                    'and' => esc_html__('AND', 'organey'),
                    'or'  => esc_html__('OR', 'organey'),
                ),
            ),
        );
    }
    ...
    protected function layered_nav_list($terms, $taxonomy, $query_type) {
        ...
        foreach ($terms as $term) {
            ...
            if ($count > 0 || $option_is_set) {
                ...
                $term_html = '<a rel="nofollow" class="organey-button-type" href="' . $link . '">' . esc_html($term->name) . '</a>';
	                ...
	                if ($attribute->type) {
		                switch ($attribute->type) {
                            case 'color':
                                ...
                                $term_html = '';
                                $term_html .= '<a rel="nofollow" class="organey-color-type" href="' . esc_url($link) . '">';
                            ...
                            case 'image':
                                ...
                                $term_html = '';
                                $term_html .= '<a rel="nofollow" class="organey-image-type" href="' . esc_url($link) . '">';
